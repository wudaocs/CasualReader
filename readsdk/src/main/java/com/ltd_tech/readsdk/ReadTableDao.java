...
/** 
 * DAO for table "READ_TABLE".
*/
public class ReadTableDao extends AbstractDao<ReadTable, String> {

    public static final String TABLENAME = "READ_TABLE";

    /**
     * Properties of entity ReadTable.<br/>
    ...
    public ReadTableDao(DaoConfig config) {
        super(config);
    }
    
    public ReadTableDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"READ_TABLE\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"READ_TABLE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, ReadTable entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, ReadTable entity) {
        stmt.clearBindings();
    ...
    @Override
    public ReadTable readEntity(Cursor cursor, int offset) {
        ReadTable entity = new ReadTable( //
    ...
    @Override
    public void readEntity(Cursor cursor, ReadTable entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(ReadTable entity, long rowId) {
        return entity.getBookId();
    }
    
    @Override
    public String getKey(ReadTable entity) {
        if(entity != null) {
            return entity.getBookId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(ReadTable entity) {

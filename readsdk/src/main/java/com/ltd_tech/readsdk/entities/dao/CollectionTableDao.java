...
/** 
 * DAO for table "COLLECTION_TABLE".
*/
public class CollectionTableDao extends AbstractDao<CollectionTable, String> {

    public static final String TABLENAME = "COLLECTION_TABLE";

    /**
     * Properties of entity CollectionTable.<br/>
    ...
    public CollectionTableDao(DaoConfig config) {
        super(config);
    }
    
    public CollectionTableDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"COLLECTION_TABLE\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"COLLECTION_TABLE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, CollectionTable entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, CollectionTable entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void attachEntity(CollectionTable entity) {
    ...
    @Override
    public CollectionTable readEntity(Cursor cursor, int offset) {
        CollectionTable entity = new CollectionTable( //
    ...
    @Override
    public void readEntity(Cursor cursor, CollectionTable entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(CollectionTable entity, long rowId) {
        return entity.get_id();
    }
    
    @Override
    public String getKey(CollectionTable entity) {
        if(entity != null) {
            return entity.get_id();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(CollectionTable entity) {

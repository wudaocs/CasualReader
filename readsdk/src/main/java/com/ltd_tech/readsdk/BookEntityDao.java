...
*/
public class BookEntityDao extends AbstractDao<BookEntity, String> {
    ...
    @Override
    protected final String updateKeyAfterInsert(BookEntity entity, long rowId) {
        return entity.get_id();
    }
    
    @Override
    public String getKey(BookEntity entity) {
        if(entity != null) {
            return entity.get_id();
        } else {
            return null;
